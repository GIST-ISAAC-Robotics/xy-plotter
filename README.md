...
- 출력 좌표계는 A4 가로 방향 `297 × 210 mm`입니다.
- 프로그램은 용지 왼쪽 아래를 `(0, 0)`으로 사용하며, 시작할 때 현재 위치를 원점으로 설정하는 `G92 X0 Y0`을 출력합니다.
- 실행 전 플로터의 펜 위치를 A4 용지의 왼쪽 아래 원점에 맞춰야 합니다.
- 기본 펜 명령은 다음과 같습니다.
...
- A4 가로 방향 출력에 맞춰져 있으며 다른 용지 크기는 소스의 상수를 수정해야 합니다.
